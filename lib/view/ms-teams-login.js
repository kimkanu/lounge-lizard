...
class MsTeamsLogin {
  constructor(window) {
    ...
    this.browser.onStartNavigation = (...e) => console.log('nav!!', e)

    this.view.addChildView(this.browser)
  }

  load() {
    this.browser.loadURL("https://login.microsoftonline.com/common/oauth2/authorize?response_type=id_token&client_id=5e3ce6c0-2b1f-4285-8d4b-75ee78787346&redirect_uri=https://teams.microsoft.com/go&state=d0a98567-5920-48a4-98d6-154eb6a3da3d&=&client-request-id=698f2a0f-5b79-4cec-8920-b24984121613&x-client-SKU=Js&x-client-Ver=1.0.9&nonce=d9b03da4-38c6-4f7f-98a3-04eeede598c6&domain_hint=")
  }
